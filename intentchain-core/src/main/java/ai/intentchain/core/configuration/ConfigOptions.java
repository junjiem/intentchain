...
public class ConfigOptions {
    ...
    public static final class OptionBuilder {
         ...
         */
        @SuppressWarnings("unchecked")
        private static final Class<Map<String, List<String>>> PROPERTIES_MAP_LIST_CLASS =
        ...
        /**
         * Defines that the value of the option should be a set of properties, which can be
         * represented as {@code Map<String, List<String>>}.
         */
        public TypedConfigOptionBuilder<Map<String, List<String>>> mapListType() {
            return new TypedConfigOptionBuilder<>(key, PROPERTIES_MAP_LIST_CLASS);
        }
